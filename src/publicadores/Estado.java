...
public class Estado implements java.io.Serializable {
    ...
    public static final Estado Inscripto = new Estado(_Inscripto);
    public static final Estado Aceptado = new Estado(_Aceptado);
    public static final Estado Rechazado = new Estado(_Rechazado);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://publicadores/", "estado"));
    }
    /**
